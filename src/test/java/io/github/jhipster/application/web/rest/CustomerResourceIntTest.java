...
public class CustomerResourceIntTest {
    ...
    public void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getNome()).isEqualTo(DEFAULT_NOME);
        assertThat(testCustomer.getCognome()).isEqualTo(DEFAULT_COGNOME);
        assertThat(testCustomer.getTelefono()).isEqualTo(DEFAULT_TELEFONO);
    ...
    public void updateCustomer() throws Exception {
        ...
        Customer testCustomer = customerList.get(customerList.size() - 1);
        assertThat(testCustomer.getNome()).isEqualTo(UPDATED_NOME);
        assertThat(testCustomer.getCognome()).isEqualTo(UPDATED_COGNOME);
        assertThat(testCustomer.getTelefono()).isEqualTo(UPDATED_TELEFONO);
