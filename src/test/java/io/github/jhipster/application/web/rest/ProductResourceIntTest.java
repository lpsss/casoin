...
public class ProductResourceIntTest {
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getNome()).isEqualTo(DEFAULT_NOME);
        assertThat(testProduct.getCodice()).isEqualTo(DEFAULT_CODICE);
        assertThat(testProduct.getMarca()).isEqualTo(DEFAULT_MARCA);
    }
    ...
    public void updateProduct() throws Exception {
        ...
        Product testProduct = productList.get(productList.size() - 1);
        assertThat(testProduct.getNome()).isEqualTo(UPDATED_NOME);
        assertThat(testProduct.getCodice()).isEqualTo(UPDATED_CODICE);
        assertThat(testProduct.getMarca()).isEqualTo(UPDATED_MARCA);
    }
